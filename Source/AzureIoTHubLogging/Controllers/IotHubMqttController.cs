...
public class IoTHubMqttController
{
    ...
    public async Task SendEnvironmentalReading(Temperature? Temperature, RelativeHumidity? Humidity, Pressure? Pressure)
    {
        try
        {
            ...
            string messagePayload = $"" +
                ...
                $"\"pressure\":{Pressure.Value.Millibar}" +
                $"}}";
