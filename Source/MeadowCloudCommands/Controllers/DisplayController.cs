...
internal class DisplayController
{
    ...
    private Image relayOn = Image.LoadFromResource("MeadowCloudCommands.Resources.img_relay_on.bmp");
    private Image relayOff = Image.LoadFromResource("MeadowCloudCommands.Resources.img_relay_off.bmp");
    ...
    private void LoadDataLayout()
    {
        ...
        var syncImage = Image.LoadFromResource("MeadowCloudCommands.Resources.img_refreshed.bmp");
    ...
    public void UpdateWiFiStatus(bool isConnected)
    {
        var imageWiFi = isConnected
            ? Image.LoadFromResource("MeadowCloudCommands.Resources.img_wifi_connected.bmp")
            : Image.LoadFromResource("MeadowCloudCommands.Resources.img_wifi_connecting.bmp");
    ...
    public void UpdateSyncStatus(bool isSyncing)
    {
        var imageSync = isSyncing
            ? Image.LoadFromResource("MeadowCloudCommands.Resources.img_refreshing.bmp")
            : Image.LoadFromResource("MeadowCloudCommands.Resources.img_refreshed.bmp");
