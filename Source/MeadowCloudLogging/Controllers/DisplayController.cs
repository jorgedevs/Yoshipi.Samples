...
public class DisplayController
{
    ...
    private void LoadSplashLayout()
    {
        ...
        var image = Image.LoadFromResource("MeadowCloudLogging.Resources.img_meadow.bmp");
    ...
    private void LoadDataLayout()
    {
        ...
        var wifiImage = Image.LoadFromResource("MeadowCloudLogging.Resources.img_wifi_connecting.bmp");
        ...
        var syncImage = Image.LoadFromResource("MeadowCloudLogging.Resources.img_refreshed.bmp");
    ...
    public void UpdateWiFiStatus(bool isConnected)
    {
        var imageWiFi = isConnected
            ? Image.LoadFromResource("MeadowCloudLogging.Resources.img_wifi_connected.bmp")
            : Image.LoadFromResource("MeadowCloudLogging.Resources.img_wifi_connecting.bmp");
    ...
    public void UpdateSyncStatus(bool isSyncing)
    {
        var imageSync = isSyncing
            ? Image.LoadFromResource("MeadowCloudLogging.Resources.img_refreshing.bmp")
            : Image.LoadFromResource("MeadowCloudLogging.Resources.img_refreshed.bmp");
